            ...
            TextButton(
              onPressed: () {
                ...
                Provider.of<Model>(
                  context,
                  listen: false,
                ).patternDB.invertImage(entry.dbImage.id!).then((value) => onChanged());
              },
            ...
            TextButton(
              onPressed: () {
                ...
                Provider.of<Model>(
                  context,
                  listen: false,
                ).patternDB.reverseImage(entry.dbImage.id!).then((value) => onChanged());
              },
            ...
            TextButton(
              onPressed: () {
                ...
                Provider.of<Model>(
                  context,
                  listen: false,
                ).patternDB.deleteImage(entry.dbImage.id!).then((value) => onChanged());
              },
