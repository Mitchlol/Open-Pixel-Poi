                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Provider.of<Model>(
                                    context,
                                    listen: false,
                                  ).patternDB.invertImage(tuple.dbImage.id!).then((value) => setState(() {}));
                                },
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Provider.of<Model>(
                                    context,
                                    listen: false,
                                  ).patternDB.reverseImage(tuple.dbImage.id!).then((value) => setState(() {}));
                                },
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Provider.of<Model>(
                                    context,
                                    listen: false,
                                  ).patternDB.deleteImage(tuple.dbImage.id!).then((value) => setState(() {}));
                                },
