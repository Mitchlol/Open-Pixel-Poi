...
Note: the snaps are pretty hard to snap in. In cold temperatures, it can be even worse. I may loosen them or make a loose version if people ask for it. But i want to leave them as is till i can see how secure they are in hot summer temperatures. Id rather they're annoying, than springing loose.

Also Note: that the lid only fits on properly in one out of the six orientations, as the tabs need to line up and there are insets to make room for the bumps on the shell stop the main module body from falling out.

I typically use a pry tool (wedge, knife, keys, etc) to get the first snap up, then pull the rest. I also use my poi knob, or a wall, table, surface or edge to smash them back in. Not exactly user friendly, but theyre very secure. 
