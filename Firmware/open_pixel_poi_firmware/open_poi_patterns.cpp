...
// The Flutter app can create patterns using images.
// The OpenPixelPoiPatterns class can be removed once the Flutter app
//   and it's pattern loading features are stable and full featured.
